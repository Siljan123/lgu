...
TRUNCATE TABLE governance.employees, governance.positions, governance.departments CASCADE;
  ...
  insert into governance.positions (id, title, rank_order) values
    ...
    ('21111111-1111-4000-8000-000000000002', 'Municipal Vice Mayor', 2),
    ('31111111-1111-4000-8000-000000000004', 'Sangguniang Bayan Member', 4),
    ('41111111-1111-4000-8000-000000000005', 'ABC President / Liga ng mga Barangay', 5),
    ('51111111-1111-4000-8000-000000000006', 'SK Federation President', 6),
    ('21111111-1111-4000-8000-000000000007', 'IPMR (Indigenous Peoples Representative)', 7)
