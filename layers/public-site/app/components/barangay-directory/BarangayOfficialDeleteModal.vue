    ...
    >
      <div class="p-6 text-center">
        ...
        <p class="text-xs text-neutral-600 dark:text-neutral-400 mt-2">
          Are you sure you want to remove <strong class="text-neutral-900 dark:text-white">{{ official?.name }}</strong> ({{ official?.title }}) from the records? This action cannot be undone.
        </p>
