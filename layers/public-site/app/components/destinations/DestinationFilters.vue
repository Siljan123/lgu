  ...
  <div class="w-full space-y-6">
    ...
    <div class="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-2 text-xs font-medium text-[#707070] dark:text-[#a3a3a3]">
        <span>Showing <strong class="text-[#171717] dark:text-[#ffffff]">{{ filteredCount }}</strong> of {{ totalCount }} destinations</span>
      </div>
    </div>
      ...
      <button 
        ...
        :class="[
          selectedCategory === cat 
            ? 'bg-[#171717] text-[#ffffff] dark:bg-[#ffffff] dark:text-[#171717] shadow-sm' 
