        ...
        <div v-if="destinations.length > 0" class="flex flex-col lg:grid lg:grid-cols-12 gap-6 lg:gap-8 items-start">
            ...
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                ...
                <span class="text-[11px] md:text-xs text-[#707070] dark:text-[#a3a3a3]">
                  Select Start & Destination above to draw route line
                </span>
              </div>
          ...
          <div class="w-full lg:col-span-4 space-y-3 max-h-120 lg:max-h-155 overflow-y-auto pr-1">
            ...
            <div 
              v-for="item in destinations" 
              :key="item.id"
              class="p-3.5 sm:p-4 rounded-xl border border-[#e5e5e5] dark:border-[#282828] bg-[#ffffff] dark:bg-[#1a1a1a] hover:border-[#85181a] dark:hover:border-[#ef4444] transition-all cursor-pointer group shadow-xs space-y-2"
